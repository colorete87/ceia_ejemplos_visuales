...
* **Muestreo de distribuciones no normalizadas**:
...
* **Distribuciones que buscan ser lo más uniformes posibles**:
...
* **Distribución de Boltzmann para Recocido Simulado (Simulated Annealing)**:
...
* **Entropía, Chances (Odds) y Log-Odds**:
...
* **Modelo del Votante (Voter Model)**:
...
* **Kernels (Truco del Kernel)**:
  - Permite proyectar datos de baja dimensión en un espacio de características de mayor dimensión donde son linealmente separables, sin necesidad de calcular explícitamente las coordenadas en ese espacio de alta dimensión.
  - **Aplicaciones**: Máquinas de Vectores de Soporte (SVM), regresión por procesos gaussianos, análisis de componentes principales no lineal (Kernel PCA).
