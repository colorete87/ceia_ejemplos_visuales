# Organización de Comentarios y Propuestas para PEIA

Este es el archivo principal de navegación para los comentarios, sugerencias y material didáctico preparado para la materia **PEIA (Probabilidad y Estadística para Inteligencia Artificial)**.

Los contenidos se han organizado y separado en diferentes documentos para facilitar su lectura y gestión:
...
- Falsos Positivos y la Falacia del Fiscal.
...
- Métricas de información (Entropía, Odds, Log-Odds, Similitud Coseno).
- Algoritmos populares (Sistema de clasificación ELO y el Modelo del Votante).
